...
function SearchBar({setSearchCar}) {
    return (
        <div className='w-screen mt-10'>
            <div className='max-w-screen-xl mx-auto'>
                ...
                <div className='flex justify-center items-center mt-10'>
                    <input className='w-full px-3 py-2 rounded-full border-[1px] outline-none' type="text" placeholder='Search by model or company' onChange={(e)=>setSearchCar(e.target.value)}/>
                </div>
            </div>
